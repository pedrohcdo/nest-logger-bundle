...
import { BUNDLE_LOGGER_PROVIDER_TOKEN, LoggerBundleParams, LoggerBundleParamsLogggerMode } from '../../nest-logger.params';
...
export const BundleLoggerProvider: Provider = {
	...
	useFactory: async (params: LoggerBundleParams) => {
		...
		return resolveLoggerFor(params, LoggerBundleParamsLogggerMode.LOG_BUNDLE)
	},
